...
public class LevelHelper {
   ...
   static{
      ...
      barbarKingLevels.add(Level.createNewBuildingLevel(15, 2598, 65000, 14 * 12 * 60, 9));
      barbarKingLevels.add(Level.createNewBuildingLevel(16, 2701, 70000, 15 * 12 * 60, 9));
      barbarKingLevels.add(Level.createNewBuildingLevel(17, 2809, 75000, 16 * 12 * 60, 9));
      barbarKingLevels.add(Level.createNewBuildingLevel(18, 2922, 80000, 17 * 12 * 60, 9));
      barbarKingLevels.add(Level.createNewBuildingLevel(19, 3039, 85000, 18 * 12 * 60, 9));
      barbarKingLevels.add(Level.createNewBuildingLevel(20, 3160, 90000, 19 * 12 * 60, 9));
      barbarKingLevels.add(Level.createNewBuildingLevel(21, 3287, 100000, 20 * 12 * 60, 9));
      barbarKingLevels.add(Level.createNewBuildingLevel(22, 3418, 110000, 21 * 12 * 60, 9));
      barbarKingLevels.add(Level.createNewBuildingLevel(23, 3555, 115000, 22 * 12 * 60, 9));
      barbarKingLevels.add(Level.createNewBuildingLevel(24, 3697, 120000, 23 * 12 * 60, 9));
      barbarKingLevels.add(Level.createNewBuildingLevel(25, 3845, 125000, 24 * 12 * 60, 9));
      barbarKingLevels.add(Level.createNewBuildingLevel(26, 3999, 130000, 25 * 12 * 60, 9));
      barbarKingLevels.add(Level.createNewBuildingLevel(27, 4159, 135000, 26 * 12 * 60, 9));
      barbarKingLevels.add(Level.createNewBuildingLevel(28, 4325, 140000, 27 * 12 * 60, 9));
      barbarKingLevels.add(Level.createNewBuildingLevel(29, 4498, 145000, 28 * 12 * 60, 9));
      barbarKingLevels.add(Level.createNewBuildingLevel(30, 4000, 150000, 29 * 12 * 60, 10));
      barbarKingLevels.add(Level.createNewBuildingLevel(31, 4000, 155000, 30 * 12 * 60, 10));
      barbarKingLevels.add(Level.createNewBuildingLevel(32, 4000, 160000, 31 * 12 * 60, 10));
      barbarKingLevels.add(Level.createNewBuildingLevel(33, 4000, 165000, 32 * 12 * 60, 10));
      barbarKingLevels.add(Level.createNewBuildingLevel(34, 4000, 170000, 33 * 12 * 60, 10));
      barbarKingLevels.add(Level.createNewBuildingLevel(35, 4000, 175000, 34 * 12 * 60, 10));
      barbarKingLevels.add(Level.createNewBuildingLevel(36, 4000, 180000, 35 * 12 * 60, 10));
      barbarKingLevels.add(Level.createNewBuildingLevel(37, 4000, 185000, 36 * 12 * 60, 10));
      barbarKingLevels.add(Level.createNewBuildingLevel(38, 4000, 190000, 37 * 12 * 60, 10));
      barbarKingLevels.add(Level.createNewBuildingLevel(39, 4000, 195000, 38 * 12 * 60, 10));
      barbarKingLevels.add(Level.createNewBuildingLevel(40, 4000, 200000, 39 * 12 * 60, 10));
      ...
      archerQueenLevels.add(Level.createNewBuildingLevel(15, 1169, 55000, 14 * 12 * 60, 9));
      archerQueenLevels.add(Level.createNewBuildingLevel(16, 1215, 57500, 15 * 12 * 60, 9));
      archerQueenLevels.add(Level.createNewBuildingLevel(17, 1264, 60000, 16 * 12 * 60, 9));
      archerQueenLevels.add(Level.createNewBuildingLevel(18, 1315, 62500, 17 * 12 * 60, 9));
      archerQueenLevels.add(Level.createNewBuildingLevel(19, 1368, 65000, 18 * 12 * 60, 9));
      archerQueenLevels.add(Level.createNewBuildingLevel(20, 1422, 67500, 19 * 12 * 60, 9));
      archerQueenLevels.add(Level.createNewBuildingLevel(21, 1479, 70000, 20 * 12 * 60, 9));
      archerQueenLevels.add(Level.createNewBuildingLevel(22, 1538, 72500, 21 * 12 * 60, 9));
      archerQueenLevels.add(Level.createNewBuildingLevel(23, 1600, 75000, 22 * 12 * 60, 9));
      archerQueenLevels.add(Level.createNewBuildingLevel(24, 1664, 77500, 23 * 12 * 60, 9));
      archerQueenLevels.add(Level.createNewBuildingLevel(25, 1730, 80000, 24 * 12 * 60, 9));
      archerQueenLevels.add(Level.createNewBuildingLevel(26, 1800, 82500, 25 * 12 * 60, 9));
      archerQueenLevels.add(Level.createNewBuildingLevel(27, 1872, 85000, 26 * 12 * 60, 9));
      archerQueenLevels.add(Level.createNewBuildingLevel(28, 1946, 87500, 27 * 12 * 60, 9));
      archerQueenLevels.add(Level.createNewBuildingLevel(29, 2024, 90000, 28 * 12 * 60, 9));
      archerQueenLevels.add(Level.createNewBuildingLevel(30, 2105, 95000, 29 * 12 * 60, 9));
      archerQueenLevels.add(Level.createNewBuildingLevel(31, 2000, 100000, 30 * 12 * 60, 10));
      archerQueenLevels.add(Level.createNewBuildingLevel(32, 2000, 110000, 31 * 12 * 60, 10));
      archerQueenLevels.add(Level.createNewBuildingLevel(33, 2000, 120000, 32 * 12 * 60, 10));
      archerQueenLevels.add(Level.createNewBuildingLevel(34, 2000, 130000, 33 * 12 * 60, 10));
      archerQueenLevels.add(Level.createNewBuildingLevel(35, 2000, 140000, 34 * 12 * 60, 10));
      archerQueenLevels.add(Level.createNewBuildingLevel(36, 2000, 150000, 35 * 12 * 60, 10));
      archerQueenLevels.add(Level.createNewBuildingLevel(37, 2000, 160000, 36 * 12 * 60, 10));
      archerQueenLevels.add(Level.createNewBuildingLevel(38, 2000, 170000, 37 * 12 * 60, 10));
      archerQueenLevels.add(Level.createNewBuildingLevel(39, 2000, 180000, 38 * 12 * 60, 10));
      archerQueenLevels.add(Level.createNewBuildingLevel(40, 2000, 190000, 39 * 12 * 60, 10));
   }
