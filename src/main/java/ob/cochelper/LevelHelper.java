...
public class LevelHelper {
   ...
   static{
      ...
      cannonLevels.add(new Level(7, 630, 200000, 1440, 6));
      cannonLevels.add(new Level(8, 660, 400000, 2 * 1440, 7));
      cannonLevels.add(new Level(9, 690, 800000, 3 * 1440, 8));
      cannonLevels.add(new Level(10, 750, 1600000, 4 * 1440, 8));
      cannonLevels.add(new Level(11, 900, 3200000, 5 * 1440, 9));
      ...
      archerTowerLevels.add(new Level(6, 610, 180000, 1440, 5));
      archerTowerLevels.add(new Level(7, 630, 360000, 3 * 1440, 6));
      archerTowerLevels.add(new Level(8, 660, 720000, 4 * 1440, 7));
      archerTowerLevels.add(new Level(9, 690, 1500000, 5 * 1440, 8));
      archerTowerLevels.add(new Level(10, 720, 2500000, 6 * 1440, 8));
      archerTowerLevels.add(new Level(11, 750, 5000000, 7 * 1440, 9));

      mortarLevels.add(new Level(1, 400, 8000, 8 * 60, 3));
      mortarLevels.add(new Level(2, 450, 32000, 12 * 60, 4));
      mortarLevels.add(new Level(3, 500, 120000, 1440, 5));
      mortarLevels.add(new Level(4, 550, 400000, 2 * 1440, 6));
      mortarLevels.add(new Level(5, 590, 800000, 4 * 1440, 7));
      mortarLevels.add(new Level(6, 610, 1600000, 5 * 1440, 8));
      mortarLevels.add(new Level(7, 640, 3200000, 7 * 1440, 9));

      wizardTowerLevels.add(new Level(1, 620, 180000, 12 * 60, 5));
      wizardTowerLevels.add(new Level(2, 660, 360000, 1440, 5));
      wizardTowerLevels.add(new Level(3, 690, 720000, 2 * 1440, 6));
      wizardTowerLevels.add(new Level(4, 720, 1280000, 4 * 1440, 7));
      wizardTowerLevels.add(new Level(5, 760, 1960000, 6 * 1440, 8));
      wizardTowerLevels.add(new Level(6, 800, 2680000, 8 * 1440, 8));
      ...
      airDefenseLevels.add(new Level(2, 860, 90000, 1440, 4));
      airDefenseLevels.add(new Level(3, 900, 270000, 3 * 1440, 5));
      airDefenseLevels.add(new Level(4, 940, 540000, 5 * 1440, 6));
      airDefenseLevels.add(new Level(5, 990, 1080000, 6 * 1440, 7));
      airDefenseLevels.add(new Level(6, 1040, 2160000, 8 * 1440, 8));
      airDefenseLevels.add(new Level(7, 1100, 6480000, 10 * 1440, 9));

      hiddenTeslaLevels.add(new Level(1, 600, 1000000, 2 * 1440, 7));
      hiddenTeslaLevels.add(new Level(2, 630, 1250000, 4 * 1440, 7));
      hiddenTeslaLevels.add(new Level(3, 660, 1500000, 6 * 1440, 7));
      ...
      xBowLevels.add(new Level(2, 2400, 8000000, 14 * 1440, 9));
      ...
      elixirCollectorLevels.add(new ResourceLevel(7, 630, 14000, 1440, 4, 30000, 1600));
      elixirCollectorLevels.add(new ResourceLevel(8, 660, 28000, 2 * 1440, 4, 50000, 1900));
      elixirCollectorLevels.add(new ResourceLevel(9, 680, 56000, 3 * 1440, 5, 75000, 2200));
      elixirCollectorLevels.add(new ResourceLevel(10, 710, 84000, 4 * 1440, 5, 100000, 2500));
      elixirCollectorLevels.add(new ResourceLevel(11, 750, 168000, 5 * 1440, 7, 150000, 3000));
      ...
      goldMineLevels.add(new ResourceLevel(7, 630, 14000, 1440, 4, 30000, 1600));
      goldMineLevels.add(new ResourceLevel(8, 660, 28000, 2 * 1440, 4, 50000, 1900));
      goldMineLevels.add(new ResourceLevel(9, 680, 56000, 3 * 1440, 5, 75000, 2200));
      goldMineLevels.add(new ResourceLevel(10, 710, 84000, 4 * 1440, 5, 100000, 2500));
      goldMineLevels.add(new ResourceLevel(11, 750, 168000, 5 * 1440, 7, 150000, 3000));

      darkElixirDrillLevels.add(new ResourceLevel(1, 400, 1000000, 1440, 8, 120, 20));
      darkElixirDrillLevels.add(new ResourceLevel(2, 480, 2000000, 2 * 1440, 8, 240, 30));
      darkElixirDrillLevels.add(new ResourceLevel(3, 580, 3000000, 3 * 1440, 8, 450, 45));
      darkElixirDrillLevels.add(new ResourceLevel(4, 690, 4000000, 4 * 1440, 9, 720, 60));
      darkElixirDrillLevels.add(new ResourceLevel(5, 830, 6000000, 6 * 1440, 9, 1120, 80));
      darkElixirDrillLevels.add(new ResourceLevel(6, 1000, 8000000, 8 * 1440, 9, 1600, 100));
      ...
      goldStorageLevels.add(new ResourceLevel(10, 1920, 250000, 1440, 6, 1000000, 0));
      goldStorageLevels.add(new ResourceLevel(11, 2016, 500000, 2 * 1440, 7, 2000000, 0));
      ...
      elixirStorageLevels.add(new ResourceLevel(10, 1920, 250000, 1440, 6, 1000000, 0));
      elixirStorageLevels.add(new ResourceLevel(11, 2016, 500000, 2 * 1440, 7, 2000000, 0));

      darkElixirStorageLevels.add(new ResourceLevel(1, 1500, 600000, 1440, 7, 10000, 0));
      darkElixirStorageLevels.add(new ResourceLevel(2, 1650, 1200000, 2 * 1440, 7, 20000, 0));
      darkElixirStorageLevels.add(new ResourceLevel(3, 2000, 1800000, 3 * 1440, 8, 40000, 0));
      darkElixirStorageLevels.add(new ResourceLevel(4, 2200, 2400000, 4 * 1440, 8, 80000, 0));
      darkElixirStorageLevels.add(new ResourceLevel(5, 2400, 3000000, 5 * 1440, 9, 150000, 0));
      darkElixirStorageLevels.add(new ResourceLevel(6, 2650, 3600000, 6 * 1440, 9, 200000, 0));
      ...
      armyCampLevels.add(new Level(5, 800, 250000, 1440, 5));
      armyCampLevels.add(new Level(6, 1000, 750000, 3 * 1440, 6));
      armyCampLevels.add(new Level(7, 1200, 2250000, 5 * 1440, 9));
      ...
      barrackLevels.add(new Level(7, 340, 240000, 1440, 5));
      barrackLevels.add(new Level(8, 350, 700000, 2 * 1440, 6));
      barrackLevels.add(new Level(9, 390, 1500000, 4 * 1440, 7));
      barrackLevels.add(new Level(10, 420, 2000000, 6 * 1440, 8));
      ...
      laboratoryLevels.add(new Level(4, 290, 270000, 1440, 6));
      laboratoryLevels.add(new Level(5, 310, 540000, 2 * 1440, 7));
      laboratoryLevels.add(new Level(6, 330, 1080000, 4 * 1440, 8));
      laboratoryLevels.add(new Level(7, 350, 3000000, 5 * 1440, 9));

      spellFactoryLevels.add(new Level(1, 200, 200000, 1440, 5));
      spellFactoryLevels.add(new Level(2, 300, 400000, 2 * 1440, 6));
      spellFactoryLevels.add(new Level(3, 400, 800000, 4 * 1440, 7));
      spellFactoryLevels.add(new Level(4, 500, 1600000, 5 * 1440, 9));
      ...
      townHallLevels.add(new Level(4, 2100, 25000, 1440, 3));
      townHallLevels.add(new Level(5, 2400, 150000, 2 * 1440, 4));
      townHallLevels.add(new Level(6, 2800, 750000, 4 * 1440, 5));
      townHallLevels.add(new Level(7, 3200, 1200000, 6 * 1440, 6));
      townHallLevels.add(new Level(8, 3700, 2000000, 8 * 1440, 7));
      townHallLevels.add(new Level(9, 4200, 4000000, 10 * 1440, 8));
      ...
      barbarKingLevels.add(new Level(23, 3555, 120000, 22 * 12 * 60, 9));
      barbarKingLevels.add(new Level(24, 3697, 130000, 23 * 12 * 60, 9));
      barbarKingLevels.add(new Level(25, 3845, 140000, 24 * 12 * 60, 9));
      barbarKingLevels.add(new Level(26, 3999, 150000, 25 * 12 * 60, 9));
      barbarKingLevels.add(new Level(27, 4159, 160000, 26 * 12 * 60, 9));
      barbarKingLevels.add(new Level(28, 4325, 170000, 27 * 12 * 60, 9));
      barbarKingLevels.add(new Level(29, 4498, 180000, 28 * 12 * 60, 9));
      barbarKingLevels.add(new Level(30, 4678, 190000, 29 * 12 * 60, 9));
      
      archerQueenLevels.add(new Level(1, 675, 40000, 0, 9));
      archerQueenLevels.add(new Level(2, 702, 45000, 12 * 60, 9));
      archerQueenLevels.add(new Level(3, 730, 50000, 2 * 12 * 60, 9));
      archerQueenLevels.add(new Level(4, 759, 55000, 3 * 12 * 60, 9));
      archerQueenLevels.add(new Level(5, 790, 60000, 4 * 12 * 60, 9));
      archerQueenLevels.add(new Level(6, 821, 65000, 5 * 12 * 60, 9));
      archerQueenLevels.add(new Level(7, 854, 70000, 6 * 12 * 60, 9));
      archerQueenLevels.add(new Level(8, 888, 75000, 7 * 12 * 60, 9));
      archerQueenLevels.add(new Level(9, 924, 80000, 8 * 12 * 60, 9));
      archerQueenLevels.add(new Level(10, 961, 85000, 9 * 12 * 60, 9));
      archerQueenLevels.add(new Level(11, 999, 90000, 10 * 12 * 60, 9));
      archerQueenLevels.add(new Level(12, 1039, 95000, 11 * 12 * 60, 9));
      archerQueenLevels.add(new Level(13, 1081, 100000, 12 * 12 * 60, 9));
      archerQueenLevels.add(new Level(14, 1124, 105000, 13 * 12 * 60, 9));
      archerQueenLevels.add(new Level(15, 1169, 110000, 14 * 12 * 60, 9));
      archerQueenLevels.add(new Level(16, 1215, 115000, 15 * 12 * 60, 9));
      archerQueenLevels.add(new Level(17, 1264, 120000, 16 * 12 * 60, 9));
      archerQueenLevels.add(new Level(18, 1315, 125000, 17 * 12 * 60, 9));
      archerQueenLevels.add(new Level(19, 1368, 130000, 18 * 12 * 60, 9));
      archerQueenLevels.add(new Level(20, 1422, 135000, 19 * 12 * 60, 9));
      archerQueenLevels.add(new Level(21, 1479, 140000, 20 * 12 * 60, 9));
      archerQueenLevels.add(new Level(22, 1538, 145000, 21 * 12 * 60, 9));
      archerQueenLevels.add(new Level(23, 1600, 150000, 22 * 12 * 60, 9));
      archerQueenLevels.add(new Level(24, 1664, 155000, 23 * 12 * 60, 9));
      archerQueenLevels.add(new Level(25, 1730, 160000, 24 * 12 * 60, 9));
      archerQueenLevels.add(new Level(26, 1800, 165000, 25 * 12 * 60, 9));
      archerQueenLevels.add(new Level(27, 1872, 170000, 26 * 12 * 60, 9));
      archerQueenLevels.add(new Level(28, 1946, 175000, 27 * 12 * 60, 9));
      archerQueenLevels.add(new Level(29, 2024, 180000, 28 * 12 * 60, 9));
      archerQueenLevels.add(new Level(30, 2105, 190000, 29 * 12 * 60, 9));
   }
