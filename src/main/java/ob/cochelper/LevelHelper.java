...
public class LevelHelper {
   ...
   static{
      ...
      barbarKingLevels.add(new Level(30, 0, 150000, 29 * 12 * 60, 10));
      barbarKingLevels.add(new Level(31, 0, 155000, 30 * 12 * 60, 10));
      barbarKingLevels.add(new Level(32, 0, 160000, 31 * 12 * 60, 10));
      barbarKingLevels.add(new Level(33, 0, 165000, 32 * 12 * 60, 10));
      barbarKingLevels.add(new Level(34, 0, 170000, 33 * 12 * 60, 10));
      barbarKingLevels.add(new Level(35, 0, 175000, 34 * 12 * 60, 10));
      barbarKingLevels.add(new Level(36, 0, 180000, 35 * 12 * 60, 10));
      barbarKingLevels.add(new Level(37, 0, 185000, 36 * 12 * 60, 10));
      barbarKingLevels.add(new Level(38, 0, 190000, 37 * 12 * 60, 10));
      barbarKingLevels.add(new Level(39, 0, 195000, 38 * 12 * 60, 10));
      barbarKingLevels.add(new Level(40, 0, 200000, 39 * 12 * 60, 10));
      ...
      archerQueenLevels.add(new Level(31, 0, 190000, 30 * 12 * 60, 10));
      archerQueenLevels.add(new Level(32, 0, 190000, 31 * 12 * 60, 10));
      archerQueenLevels.add(new Level(33, 0, 190000, 32 * 12 * 60, 10));
      archerQueenLevels.add(new Level(34, 0, 190000, 33 * 12 * 60, 10));
      archerQueenLevels.add(new Level(35, 0, 190000, 34 * 12 * 60, 10));
      archerQueenLevels.add(new Level(36, 0, 190000, 35 * 12 * 60, 10));
      archerQueenLevels.add(new Level(37, 0, 190000, 36 * 12 * 60, 10));
      archerQueenLevels.add(new Level(38, 0, 190000, 37 * 12 * 60, 10));
      archerQueenLevels.add(new Level(39, 0, 190000, 38 * 12 * 60, 10));
      archerQueenLevels.add(new Level(40, 0, 190000, 39 * 12 * 60, 10));
   }
